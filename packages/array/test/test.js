...
test('substr', () => {
  const a = array.gen(5, (x) => 5)
  const b = array.gen(5, (x) => x)
...
test('generate in-place', function () {
  ...
  array.gen(10, (n, N) => Math.sin(2 * PI * n / (N - 1)), sine32)
  ...
  array.gen(10, (n, N) => Math.sin(2 * PI * n / (N - 1)), sine64)
...
test('round', function () {
  const signal = array.gen(10, (n, N) => Math.sin(2 * Math.PI * n / (N - 1)))
